...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        lesson_list = [
            {'name': 'Урок анг. яз 1', 'description': 'Знакомство с анг. языком', 'link': 'https://ru.stackoverflow.com/questions/1388409/django', 'course': course1},
            {'name': 'Урок анг. яз 2', 'description': 'Изучение алфавита анг. яз', 'link': 'https://ru.stackoverflow.com/questions/1388409/django', 'course': course1},
            {'name': 'Урок нем. яз 1', 'description': 'Знакомство с нем. языком', 'link': 'https://ru.stackoverflow.com/questions/1388409/django', 'course': course2},
            {'name': 'Урок нем. яз 2', 'description': 'Изучение алфавита нем. яз', 'link': 'https://ru.stackoverflow.com/questions/1388409/django', 'course': course2},
        ]
        lesson_for_create = []
